...
const TokenOwned = ({ tokenName, tokenPic, tokenNum, tokenSupply, esLink, osLink }) => {
  return (
    <div className="bg-stone-700/80 p-6 rounded-2xl shadow-lg">
      <div className="flex flex-col space-y-4">
        <div className="flex flex-row space-x-2 items-center">
          <img className="object-cover h-10 w-10 rounded-full" src="https://statik.tempo.co/data/2022/03/20/id_1096687/1096687_720.jpg" alt="" />
          <div className="flex flex-col">
            <p className="font-archivo text-sm font-semibold text-stone-100">Olivia Rodrigo</p>
            <p className="font-archivo text-sm font-light text-stone-300">@oliviarodrigo</p>
          </div>
        </div>
        {/* Token info */}
        <div className="flex flex-row space-x-9">
          <a href={osLink} target="_blank" rel="noopener noreferrer">
          ...
          <div className="flex flex-col space-y-9">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex flex-row space-x-4 items-center">
                <p className="font-archivo font-regular text-sm text-white">#{tokenNum}</p>
                <p className="font-archivo font-regular text-[10px] text-stone-400">of {tokenSupply}</p>
              </div>
            </div>

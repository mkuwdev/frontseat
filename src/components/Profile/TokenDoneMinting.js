...
const TokenDoneMinting = ({ tokenName, tokenPic, esLink, osCollLink }) => {
  return (
                ...
                <div className="flex flex-col space-y-4">
                  <div>
                    <div className="flex justify-end mb-0">
                      <span class="font-archivo font-regular text-[10px] text-stone-300">100% minted</span>
                    </div>
                    <div className="w- bg-white rounded-full h-2 shadow-sm">
                      <div className="bg-stone-400 h-2 rounded-full" style={{ width: "100%" }}></div>
                    </div>
                  </div>
                  <p className="font-archivo font-regular text-[10px] text-stone-300"></p>
                </div>
              </div>
            </div>
            {/* Token links */}
            <div className="flex flex-col space-y-1 pl-4">
              ...
              <a href={osCollLink} target="_blank" rel="noopener noreferrer">
                <div className="flex flex-row space-x-2 justify-end items-center hover:cursor-pointer ">
                  ...
                  <p className="font-archivo font-semibold text-xs text-white hover:underline">Buy on OpenSea</p>
                  <ArrowSmRightIcon className="h-3 w-3 text-white" />
                </div>
              </a>
            </div>
...
export default TokenDoneMinting